...
class LLM:
    ...
    def generate(
        ...
        sampling_params: Optional[Union[SamplingParams,
                                        Sequence[SamplingParams]]] = None,
        his_diff_user_embs: Optional[Union[list[torch.Tensor], torch.Tensor]] = None,
        ...
        self._validate_and_add_requests(
            ...
            his_diff_user_embs=his_diff_user_embs,
            use_tqdm=use_tqdm,
        ...
        *,
        ...
        for i, prompt in enumerate(it):
            self._add_request(
                ...
                his_diff_user_emb=his_diff_user_embs[i] if isinstance(his_diff_user_embs, Sequence) else his_diff_user_embs,
                tokenization_kwargs=tokenization_kwargs,
