...
class LLM:
    ...
    def generate(
        ...
        sampling_params: Optional[Union[SamplingParams,
                                        Sequence[SamplingParams]]] = None,
        his_output_embs: Optional[Union[list[torch.Tensor], torch.Tensor]] = None,
        ...
        self._validate_and_add_requests(
            ...
            his_output_embs=his_output_embs,
            use_tqdm=use_tqdm,
        ...
        *,
        ...
        for i, prompt in enumerate(it):
            self._add_request(
                ...
                his_output_emb=his_output_embs[i] if isinstance(his_output_embs, Sequence) else his_output_embs,
                tokenization_kwargs=tokenization_kwargs,
